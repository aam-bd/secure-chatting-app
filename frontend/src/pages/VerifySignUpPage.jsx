...
const VerifySignUpPage = () => {
  ...
  const { verifySignupOtp, resendOtp, isVerifyingOtp } = useAuthStore();
  ...
  return (
    <div className="h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <p className="text-base-content/60">Enter the OTP sent to {email || "your email"}.</p>
            </div>
          </div>
      ...
      <AuthImagePattern
        title="Almost there"
        subtitle="Enter the one-time code sent to your email to finish creating your account."
      />
    </div>
  );
};
